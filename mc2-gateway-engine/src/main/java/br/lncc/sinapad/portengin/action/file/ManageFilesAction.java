...
public class ManageFilesAction extends BaseAction {
	...
	public static Logger logger = Logger.getLogger(ManageFilesAction.class);
	...
	@Action(value = "/manageFiles", results = { @Result(name = "success", location = "/file_manager.jsp"), @Result(name = "error", location = "/file_manager.jsp") })
